...
?>
    ...
    <main class="main-page">
      <div class="container">
        ...
        <form method="post"name="regform" class="form-user" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        
          <?php echo"$success";?>
          <?php echo"$fail";?>
          <div class="form-user__title"><h2>Registration</h2></div>
          <label class="form-user__label">
          <?php echo"$first_name_err";?>
            <span class="label-title">Your first name</span>
            <!-- /.label-title -->
            <input type="text" class="form-user__input" name="first_name" required>
          </label>
          <label class="form-user__label">
          <?php echo"$last_name_err";?>
            <span class="label-title">Your last name</span>
            <!-- /.label-title -->
            <input type="text" class="form-user__input" name="last_name" required>
          </label>
          <label class="form-user__label">
          <?php echo"$username_err";?>
            <span class="label-title">Your username</span>
            <!-- /.label-title -->
            <input type="text" class="form-user__input" name="username" required>
          </label>
          <label class="form-user__label">
          ...
          <label class="form-user__label">
            ...
            <!-- /.label-title -->
            <input type="password" class="form-user__input" name="password2" required>
          </label>
          <label class="form-user__label">
          <?php echo"$email_err";?>
            <span class="label-title">Your email</span>
            <!-- /.label-title -->
            <input type="email" class="form-user__input" name="email" required>
          </label>
          <label class="form-user__label">
          <?php echo"$country_error";?>
            <span class="label-title">Country</span>
            <!-- /.label-title -->
            <select name="country"  class="form-user__input">
          ...
          <label class="form-user__label">
            <span class="label-title">Referal</span>
          
           <input type="text" class="form-user__input"id="code" placeholder="" value="<?php echo"$referal";?>" name="code" <?php echo"$require";?>>
          </label>
       ...
       <?php echo"$btc_address_error";?>
            <span class="label-title">Bitcoin Address</span>
            <!-- /.label-title -->
            <input type="text" class="form-user__input" name="wallet"  placeholder="optional">
          </label>		  
          ...
          <div class="form-user__checkbox">
            ...
            <label for="p1">I agree with <a href="indexa972.php?a=rules">terms and conditions</a></label>
          </div>
...
<!-- Mirrored from <?php echo"$site_name3";?>/?a=signup by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jan 2021 01:58:51 GMT -->
</html>