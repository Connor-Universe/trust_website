                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Referal Link: </h4> <input class= "form-control" id="input" type="text" value ="<?php echo"$site_link123";?>/indexcca3.php?r=<?php echo"$referal_code";?>" disabled><button class="btn btn-primary" onclick="JSalert()" id="clipboardCopy">Copy</button>
