        ...
        <div class="row">
          <div class="col-lg-12">
            <h3>Referal Link</h3>
                ...
                <div class="card-body">
                  <input type= "text" value="<?php echo"$site_link123";?>/indexcca3.php?r=<?php echo "$promo";?>" class="form-control" id="input" disabled> <button id="clipboardCopy" onclick="JSalert()" class="btn btn-primary">Copy</button>
