    ...
    <main class="main-page">
      <div class="container">
        <section class="section-page section-separate">
          <div class="section-title"><h2>Rules & Agreements.</h2></div>
          <div class="section-text">
            <p>Please read the following rules carefully before signing in.</p>
          </div>
          <div class="rules-list">

            <div class="rules-item wow fadeInUp" data-wow-delay="0.2s">
      ...
      <!-- /.container -->
    </main><?php include("include/foot.php");?>
  </div>
...
<!-- Mirrored from <?php echo"$site_name3";?>/?a=rules by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jan 2021 01:58:53 GMT -->
</html>