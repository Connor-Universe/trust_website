      ...
      <div class="container">
        <section class="section-page section-separate">
          ...
          <div class="section-text">
            <p>The answers to the most important questions on the project are collected in this section. To make it easier for you to find what you are looking for, we arranged them in the appropriate categories.</p>
          </div>
          <div class="tabs faq-tabs">
            ...
            <div class="tabs__content faq-tabs__content active">
              ...
              <ul class="faq-tabs-list">
                <li>
                  ...
                  <p>In order to register in this project, you need to click on the "Registration" button at the top of the page and fill in the required fields of the questionnaire.</p>
                </li>
                <li>
                  <div class="faq-tabs-list__number">2. Who is allowed to register and participate in this investment project?</div>
                  <p>Any adult citizen. The country of residence does not matter.</p>
                </li>
                <li>
                  <div class="faq-tabs-list__number">3. Is the investor obligated to provide reliable information about himself?</div>
            ...
            <div class="tabs__content faq-tabs__content">
              ...
              <ul class="faq-tabs-list">
                <li>
                  ...
                  <p>To log in, you must use the login and password that you have chosen and indicated during the registration.</p>
                </li>
                <li>
                ...
                <li>
                  <div class="faq-tabs-list__number">3. What should I do if I forgot my password for logging in to my account?</div>
            ...
            <div class="tabs__content faq-tabs__content">
              ...
              <ul class="faq-tabs-list">
                <li>
                  <div class="faq-tabs-list__number">1. How quickly after registration does the investor need to make a deposit?</div>
                  <p>At any convenient time. After registration, you can carefully study the conditions of the service plans and only after that make the deposit.</p>
                </li>
                <li>
                ...
                <li>
                  ...
                  <p>No, all payments are instant and conducted without commissions. The minimum withdrawal amount is 0.0005 BTC. </p>
                </li>
              </ul>
            </div>
            ...
            <div class="tabs__content faq-tabs__content">
              ...
              <ul class="faq-tabs-list clearfix">
                <li>
                  ...
                  <p>It is enough to be a registered participant in the project. Your referral link is stored in your personal cabinet.</p>
                </li>
                <li>
                  <div class="faq-tabs-list__number">2. Do I have to have an active deposit to profit from the referral program?</div>
                  <p>No, you must not.</p>
                </li>
                <li>
                  <div class="faq-tabs-list__number">3. How many levels are there in the referral system?</div>
                  <p>There are two levels in the referral system of our project, this will allow you to make profit from sub-referrals.</p>
                </li>
              </ul>
            </div>
...
<!-- Mirrored from <?php echo"$site_name3";?>/?a=faq by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jan 2021 01:58:53 GMT -->
</html>